...
<div class="productdetails-view productdetails" {VM_PRODUCT_WRAPPER}>
    ...
    <?php // Product Title   ?>
    <h1 {VM_PRODUCT_NAME}><?php echo $this->product->product_name ?></h1>
...
?>
	...
	<div class="vm-product-details-container">
		...
		<?php
		echo shopFunctionsF::renderVmSubLayout('rating',array('showRating'=>$this->showRating,'product'=>$this->product, 'rating_reviews' => count($this->rating_reviews)));
...
<?php
	...
	if (!empty($this->product->product_desc)) {
	    ?>
        <div class="product-description" {VM_PRODUCT_DESCR}>
