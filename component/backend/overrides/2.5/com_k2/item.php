...
<div {K2_BODY_WRAPPER} id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemHeader">
	  ...
	  <!-- Item title -->
	  <h2 class="itemTitle" {K2_ITEM_TITLE}>
  ...
  <div class="itemBody">
	  ...
	  <!-- Item Image -->
	  <div class="itemImageBlock" {K2_ITEM_IMAGE_WRAPPER}>
		  <span class="itemImage">
		  	<a class="modal" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
		  		<img {K2_ITEM_IMAGE} src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;" />
		  	</a>
		  </span>

		  <?php if($this->item->params->get('itemImageMainCaption') && !empty($this->item->image_caption)): ?>
		  <!-- Image caption -->
		  <span class="itemImageCaption" {K2_ITEM_IMAGE_CAPTION}><?php echo $this->item->image_caption; ?></span>
		  <?php endif; ?>

		  <?php if($this->item->params->get('itemImageMainCredits') && !empty($this->item->image_credits)): ?>
		  <!-- Image credits -->
		  <span class="itemImageCredits" {K2_ITEM_IMAGE_CREDITS}><?php echo $this->item->image_credits; ?></span>
		  <?php endif; ?>
	  ...
	  <!-- Item introtext -->
	  <div class="itemIntroText" {K2_ITEM_DESCR}>
	  	<?php echo $this->item->introtext; ?>
	  </div>
	  <?php endif; ?>
	  <?php if($this->item->params->get('itemFullText')): ?>
	  <!-- Item fulltext -->
	  <div class="itemFullText" {K2_ITEM_DESCR}>
 ...
 <?php if($this->item->params->get('itemComments') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2')) && empty($this->item->event->K2CommentsBlock)): ?>
  ...
  <div class="itemComments">
	  ...
	  <ul class="itemCommentsList">
	    ...
	    <li {K2_ITEM_COMMENT} class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
	    	...
	    	<span class="commentLink">
				...
				<span class="commentDate">
					<time {K2_ITEM_COMMENT_DATE:<?php echo $comment->commentDate ?>}>
		    ...
		    <span class="commentAuthorName">
			    ...
			    <a href="<?php echo JFilterOutput::cleanText($comment->userLink); ?>" title="<?php echo JFilterOutput::cleanText($comment->userName); ?>" target="_blank" rel="nofollow">
			    	<span {K2_ITEM_COMMENT_AUTHOR}><?php echo $comment->userName; ?></span>
			    </a>
			    <?php else: ?>
					<span {K2_ITEM_COMMENT_AUTHOR}><?php echo $comment->userName; ?></span>
			    <?php endif; ?>
		    ...
		    <p {K2_ITEM_COMMENT_TEXT}><?php echo $comment->commentText; ?></p>
