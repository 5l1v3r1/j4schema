...
<tr>
	...
	<td {BLOG_ARTICLE_TITLE} class="contentheading<?php echo $this->escape($this->item->params->get( 'pageclass_sfx' )); ?>" width="100%">
		<?php if ($this->item->params->get('link_titles') && $this->item->readmore_link != '') : ?>
		<a {BLOG_ARTICLE_TITLE_LINK} href="<?php echo $this->item->readmore_link; ?>" class="contentpagetitle<?php echo $this->escape($this->item->params->get( 'pageclass_sfx' )); ?>">
...
<tr>
	<td valign="top" colspan="2" class="createdate">
		<time {ARTICLE_PUBLISH_UP:<?php echo $this->item->created?>}>
...
<tr>
<td valign="top" colspan="2" {BLOG_TEXT_WRAPPER}>
