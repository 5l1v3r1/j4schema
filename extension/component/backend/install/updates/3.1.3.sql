...
('virtuemart', 'VM_PRODUCT_WRAPPER', 'text', 'itemscope itemtype="http://schema.org/Product"', 1),
('virtuemart', 'VM_PRODUCT_NAME', 'text', ' itemprop="name"', 1),
('virtuemart', 'VM_PRODUCT_DESCR', 'text', ' itemprop="description"', 1),
('virtuemart', 'VM_PRICE_WRAPPER', 'text', ' itemscope itemtype="http://schema.org/Offer" itemprop="offers"', 1),
('virtuemart', 'VM_PRICE', 'text', ' itemprop="price"', 1),
('virtuemart', 'VM_MAIN_IMAGE', 'text', ' itemprop="image"', 1),
('virtuemart', 'VM_RATING_WRAPPER', 'text', ' itemscope itemtype="http://schema.org/AggregateRating" itemprop="aggregateRating"', 1),
('virtuemart', 'VM_RATING', 'text', ' itemprop="ratingValue"', 1),
('virtuemart', 'VM_MAX_RATING', 'text', ' itemprop="bestRating"', 1),
('virtuemart', 'VM_REVIEW', 'text', ' itemscope itemtype="http://schema.org/Review" itemprop="reviews"', 1),
('virtuemart', 'VM_REVIEW_BODY', 'text', ' itemprop="reviewBody"', 1),
('virtuemart', 'VM_REVIEW_RATING_WRAPPER', 'text', ' itemscope itemtype="http://schema.org/Rating" itemprop="reviewRating"', 1),
('virtuemart', 'VM_REVIEW_AUTHOR', 'text', ' itemprop="author"', 1),
('virtuemart', 'VM_PRODUCT_IN_STOCK', 'link', ' itemprop="availability" href="http://schema.org/InStock"', 1),
('virtuemart', 'VM_PRODUCT_OUT_STOCK', 'link', ' itemprop="availability" href="http://schema.org/OutOfStock"', 1),
