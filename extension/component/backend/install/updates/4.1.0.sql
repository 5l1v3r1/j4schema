...
('jevents', 'JE_EVENT_CONTACT', 'text', 'itemscope itemtype="http://schema.org/ContactPoint"', 1),
('jevents', 'JE_EVENT_LOCATION', 'text', 'itemprop="location" itemscope itemtype="http://schema.org/PostalAddress"', 1),
...
('jevents', 'JE_EVENT_WRAPPER', 'text', 'itemscope itemtype="http://schema.org/Event"', 1);